...
<nav>
 ...
 <ul id="menu">
  ...
  <li><a class="{{Request::path()==='/legitarsasag/listazas' ? 'active' : '' }}" href="/legitarsasag/listazas">Légitársaságok</a></li>
  <li><a class="{{Request::path()==='/legitarsasag/create' ? 'active' : '' }}" href="/legitarsasag/create">Légitársaság hozzáadás</a></li>
